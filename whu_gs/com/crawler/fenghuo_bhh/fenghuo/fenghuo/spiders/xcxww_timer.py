...
@author: bohaohan
@introduction: spider of http://www.xcxww.com/
'''
import codecs
import re
import datetime
...
root_domain = "http://www.xcxww.com/"
import sys
reload(sys)
...
class TongShanChinaSpider(CrawlSpider):
    name = "xcxww"
    allowed_domains = ["xcxww.com"]

    start_urls = [
        # 'http://www.xcxww.com/list-6-1.html'
        'http://www.xcxww.com/list-6-1.html'
    ]
    ...
    def parse(self, response):
        ...
        while new > 10 and hasNext:
            ...
            r.encoding = 'gb2312'
            root = bs(r.text)
            div = root.find("div", attrs={"class": "tabstyle ullist"})
            lis = div.findAll("li")
            for li in lis:
