...
root_domain = "http://www.437600.net/"
...
class tongshan_xinxigang_Spider(CrawlSpider):
    ...
    name = "tsxxgtimer"
    allowed_domains = ["437600.net"]
    start_urls = [
        'http://www.437600.net/forum.php'
    ]
    ...
    def parse(self, response):
        ...
        urls = root.findAll("a", attrs={"href": re.compile("^forum-")})
        for url in urls:
